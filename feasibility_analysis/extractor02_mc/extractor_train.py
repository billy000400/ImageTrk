...
def extractor_train(C):
    ...
    x = Conv2D(32, (3, 3), padding='same', activation='relu', kernel_initializer=initializers.RandomNormal(stddev=0.01), kernel_regularizer=regularizers.l2(0))(input_layer)
    x = MaxPool2D(pool_size=(2, 2), padding='same')(x)
    x = Dropout(0.3)(x)


    x = Conv2D(128, (3, 3), padding='same', activation='relu', kernel_initializer=initializers.RandomNormal(stddev=0.01), kernel_regularizer=regularizers.l2(0))(x)
    x = MaxPool2D(pool_size=(2, 2), padding='same')(x)
    x = Dropout(0.3)(x)


    x = Conv2D(256, (3, 3), padding='same', activation='relu', kernel_initializer=initializers.RandomNormal(stddev=0.01), kernel_regularizer=regularizers.l2(0))(x)
    x = MaxPool2D(pool_size=(2, 2), padding='same')(x)
    x = Dropout(0.3)(x)
    ...
    x = Conv2D(512, (3, 3), padding='same', activation='relu', kernel_initializer=initializers.RandomNormal(stddev=0.01), kernel_regularizer=regularizers.l2(0))(x)
    x = MaxPool2D(pool_size=(2, 2), padding='same')(x)
    x = Dropout(0.3)(x)
    ...
    x = Conv2D(1024, (3, 3), padding='same', activation='relu', kernel_initializer=initializers.RandomNormal(stddev=0.01), kernel_regularizer=regularizers.l2(0))(x)
    x = MaxPool2D(pool_size=(2, 2), padding='same')(x)
    x = Dropout(0.3)(x)
    ...
    x = Conv2D(2048, (3, 3), padding='same', activation='relu', kernel_initializer=initializers.RandomNormal(stddev=0.01), kernel_regularizer=regularizers.l2(0))(x)
    x = MaxPool2D(pool_size=(2, 2), padding='same')(x)
    x = Dropout(0.3)(x)
    ...
    LRCallback = tf.keras.callbacks.ReduceLROnPlateau(
        monitor='loss', factor=0.1, patience=100, verbose=0, mode='auto',
