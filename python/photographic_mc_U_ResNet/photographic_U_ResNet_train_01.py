...
def photographic_train(C):
    ...
    architecture = U_ResNet.U_ResNet_00(input_shape=input_shape, num_class=3)
...
if __name__ == "__main__":
    ...
    model_name = "photographic_U_ResNet_01_weighted"
    record_name = "photographic_U_ResNet_01_weighted"
