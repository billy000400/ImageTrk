...
if __name__ == "__main__":
    ...
    # mode = 'dp'
    # dp_list = []
    # dp_list.append('dig.mu2e.CeEndpoint.MDC2018b.001002_00000014.art')
    # dp_list.append('dig.mu2e.CeEndpoint.MDC2018b.001002_00000020.art')
    # dp_list.append('dig.mu2e.CeEndpoint.MDC2018b.001002_00000149.art')
    # dp_list.append('dig.mu2e.CeEndpoint.MDC2018b.001002_00000192.art')
    # dp_list.append('dig.mu2e.CeEndpoint.MDC2018b.001002_00000150.art')
    # dp_list.append('dig.mu2e.CeEndpoint.MDC2018b.001002_00000024.art')
    # dp_list.append('dig.mu2e.CeEndpoint.MDC2018b.001002_00000136.art')
    # dp_list.append('dig.mu2e.CeEndpoint.MDC2018b.001002_00000011.art')
    # window = 20 # unit: ns
    # C.set_source(dp_list)
    # C.set_window(window)
