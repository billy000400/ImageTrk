...
from Architecture import U_Net
...
def photographic_train(C):
    ...
    architecture = U_Net(input_shape, 3)
...
if __name__ == "__main__":
    ...
    model_name = "photographic_mc_overfitting_02"
    record_name = "photographic_record_mc_overfitting_02"
