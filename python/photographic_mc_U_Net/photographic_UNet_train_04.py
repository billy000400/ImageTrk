...
def photographic_train(C):
    ...
    architecture = MyUnet.U_Net_4(input_shape=input_shape, num_class=3)
...
if __name__ == "__main__":
    ...
    model_name = "photographic_UNet_04_top2weighted"
    record_name = "photographic_UNet_04_top2weighted"
