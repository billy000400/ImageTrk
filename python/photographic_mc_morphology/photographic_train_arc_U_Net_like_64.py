...
from Architecture import U_Net_Like_64
...
def photographic_train(C):
    ...
    architecture = U_Net_Like_64(input_shape, 3)
...
if __name__ == "__main__":
    ...
    model_name = "photographic_mc_arc_64"
    record_name = "photographic_record_mc_arc_64"
