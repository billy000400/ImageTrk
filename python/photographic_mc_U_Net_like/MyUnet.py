...
class U_Net:
    ...
    def get_model(self):
        ...
        conv1 = Conv2D(64, 3, activation = 'relu', padding='same', kernel_initializer=init)(input)
        ...
        conv5 = Conv2D(512, 3, activation='relu', padding='same', kernel_initializer=init)(conv5)
        conv5 = BatchNormalization()(conv5)
        conv5 = Dropout(0.4)(conv5)

        upconv1 = Conv2DTranspose(512, kernel_size=(2,2), strides=(2,2), activation='relu', padding='valid', kernel_initializer=init)(conv5)
        upconv1 = BatchNormalization()(upconv1)
        merge1 = concatenate([upconv1, conv4], axis=3)

        conv6 = Conv2D(512, 3, activation='relu', padding='same', kernel_initializer=init)(merge1)
        conv6 = BatchNormalization()(conv6)
        conv6 = Conv2D(512, 3, activation='relu', padding='same', kernel_initializer=init)(conv6)
        conv6 = BatchNormalization()(conv6)

        upconv2 = Conv2DTranspose(256, kernel_size=(2,2), strides=(2,2), activation='relu', padding='valid', kernel_initializer=init)(conv6)
        upconv2 = BatchNormalization()(upconv2)
        merge2 = concatenate([upconv2, conv3], axis=3)

        conv7 = Conv2D(256, 3, activation='relu', padding='same', kernel_initializer=init)(merge2)
        conv7 = BatchNormalization()(conv7)
        conv7 = Conv2D(256, 3, activation='relu', padding='same', kernel_initializer=init)(conv7)
        conv7 = BatchNormalization()(conv7)

        upconv3 = Conv2DTranspose(128, kernel_size=(2,2), strides=(2,2), activation='relu', padding='valid', kernel_initializer=init)(conv7)
        upconv3 = BatchNormalization()(upconv3)
        merge3 = concatenate([upconv3, conv2],axis=3)

        conv8 = Conv2D(128, 3, activation='relu', padding='same', kernel_initializer=init)(merge3)
        conv8 = BatchNormalization()(conv8)
        conv8 = Conv2D(128, 3, activation='relu', padding='same', kernel_initializer=init)(conv8)
        conv8 = BatchNormalization()(conv8)

        upconv4 = Conv2DTranspose(64, kernel_size=(2,2), strides=(2,2), activation='relu', padding='valid', kernel_initializer=init)(conv8)
        upconv4 = BatchNormalization()(upconv4)
        merge4 = concatenate([upconv4, conv1],axis=3)

        conv9 = Conv2D(64, 3, activation='relu', padding='same', kernel_initializer=init)(merge4)
