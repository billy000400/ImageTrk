...
from Architecture import U_Net_Like_L2
...
def photographic_train(C):
    ...
    architecture = U_Net_Like_L2(input_shape, 3)
...
if __name__ == "__main__":
    ...
    model_name = "photographic_mc_overfitting_01_l2"
    record_name = "photographic_record_mc_overfitting_01_l2"
