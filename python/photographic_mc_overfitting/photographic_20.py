...
def photographic_train(C):
    ...
    # setup loss
    cce = categorical_focal_loss(alpha=C.weights, gamma=2)
    ...
    train_generator = DataGenerator(C.X_train_dir, C.Y_train_dir, batch_size=1)
    val_generator = DataGenerator(C.X_val_dir, C.Y_val_dir, batch_size=1)
...
if __name__ == "__main__":
    ...
    model_name = "photographic_mc_20"
    record_name = "photographic_record_mc_20"
