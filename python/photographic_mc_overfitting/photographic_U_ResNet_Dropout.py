...
from Architecture import U_ResNet
...
def photographic_train(C):
    ...
    architecture = U_ResNet(input_shape, 3)
...
if __name__ == "__main__":
    ...
    model_name = "photographic_mc_overfitting_04"
    record_name = "photographic_record_mc_overfitting_04"
